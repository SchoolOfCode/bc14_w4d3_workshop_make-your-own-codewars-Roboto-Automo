...
Using the tax bandings below, write a function that takes in a gross total taxable income as an argument and returns what the net income is after deducting tax owed.
...
As an example, if the gross total was £11000, the function should return £11000 since there is no tax to be paid on this amount.
...
function calculateIncomeAfterTax(taxableIncome){
